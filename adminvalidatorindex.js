...
class AdminValidator{
    ...
    async setHelperParameters(adminValidatorSetAddress){
        let tranHash = await this.adminValidatorSet.setOwnersParameters(accountAddressList[0],privateKey[accountAddressList[0]],accountAddressList,adminValidatorSetAddress);
        return tranHash;
    }
    ...
    async deployNewAdminSetValidatorContractWithPrivateKey(){
        ...
        var adminValrSetAddress = await this.adminValidatorSet.deployNewAdminSetValidatorContractWithPrivateKey(ethAccountToUse,privateKeyOwner,accountAddressList);
    ...
    async addOneAdminTestCase(adminToAdd){
        ...
        try{
            ...
            */
            ...
            console.log("Error in AdminValidator:addOneAdminTestCase(): " + error);
            return false;
        }
    }
