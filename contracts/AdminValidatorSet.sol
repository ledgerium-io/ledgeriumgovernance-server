...
contract AdminValidatorSet is Voteable, Ownable {
    ...
    * @param _owner11 address, which is to be added as active admin
	* @param _owner21 address, which is to be added as active admin
	* @return A success flag
    */
	constructor (address _owner11, address _owner21) public {
